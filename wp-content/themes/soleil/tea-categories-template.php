...
<div id="primary" class="content-area">
    <main id="main" class="site-main" role="main">
        ...
        <?php $masthead_background = wp_get_attachment_image_src(get_post_thumbnail_id(get_the_ID()), 'full'); ?>
            ...
            <!-- if there are any categories in Tea categories CPT display them -->
            <?php
                ...
                <p class="mt-3"><small>For more details, please <span class="CPTContact"><a href="/wordpress/soleil/contact">Contact</a><span> us.</small></p>
        </section>
    </main>
</div>
